              ...
              <a href="https://t.me/ZacenikaBot" target="_blank" rel="noopener noreferrer">
                <Button 
                  ...
                  className={`font-bold rounded-full transition-all duration-300 ${
                    theme === 'dark' 
                      ? 'bg-white text-purple-600 hover:bg-purple-300 hover:text-white active:bg-purple-400 active:scale-95' 
                      : 'bg-purple-600 text-white hover:bg-purple-300 hover:text-white active:bg-purple-400 active:scale-95'
                  }`}
                >
                  Открыть бота
                </Button>
